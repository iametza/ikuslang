...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr <?php echo current ($klassak); ?>>
			<td class="td_klik"><?php echo $elem['izena']; ?></td>
			<td class="td_klik"><?php echo get_dbtable_field_by_id('mailak', 'izena', $elem['fk_maila']); ?></td>
			<td class="td_klik"><?php echo get_dbtable_field_by_id('irakasleak', 'izena', $elem['fk_irakaslea']); ?></td>
