<script type="text/javascript">
	function verif(){
        ...
        <?php if ($edit_id) { // Irakaslea editatzen ari bagara pasahitzak hautazkoak dira... ?>
        ...
        <?php } else { // irakasle berria bada pasahitzak derrigorrezkoak dira... ?>
		...
		return (confirm ("Irakaslea gorde?"));
	}
</script>

<div class="navbar">
	<div class="navbar-inner">
		<div class="brand"><a href="<?php echo URL_BASE_ADMIN; ?>irakasleak">Irakasleak</a> > <?php if ($edit_id) { echo $irakaslea->izena; } else { echo "Gehitu berria"; } ?></div>
	...
	<form id="f1" name="f1" method="post" action="<?php echo $url_base . "form" . $url_param; ?>" class="form-horizontal" enctype="multipart/form-data" onsubmit="javascript: return verif();">
		...
		<fieldset>
			<div class="control-group">
				...
				<input class="input-xxlarge" type="text" id="izena" name="izena" value="<?php echo testu_formatua_input ($irakaslea->izena); ?>" />
			</div>
            <div class="control-group">
				<label for="abizenak">Abizenak:</label>
				<input class="input-xxlarge" type="text" id="abizenak" name="abizenak" value="<?php echo testu_formatua_input ($irakaslea->abizenak); ?>" />
			</div>
            <div class="control-group">
				<label for="e_posta">e-posta:</label>
				<input class="input-xxlarge" type="text" id="e_posta" name="e_posta" value="<?php echo testu_formatua_input ($irakaslea->e_posta); ?>" />
			</div>
            <div class="control-group">
