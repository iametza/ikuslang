...
<div class="formularioa">
	<form id="f1" name="f1" method="post" action="<?php echo $url_base . "form" . $url_param; ?>" class="form-horizontal" enctype="multipart/form-data" onsubmit="javascript: return verif();">
        ...
        <fieldset>
            ...
            <?php if ($hitzak_markatu->ikus_entzunezkoa->mota == "bideoa") { ?>
            <div>
            ...
            <?php } else if ($hitzak_markatu->ikus_entzunezkoa->mota == "audioa") { ?>
            <div>
            ...
            <? } else { ?>
            <div>
                <div>Hitzak markatu ariketa honek ez dauka ikus-entzunezkorik oraindik.</div>
            </div>
            <?php } ?>
        </fieldset>
        ...
        <fieldset>
            ...
            <? } else { ?>
            <div>
                <div>Hitzak markatu ariketa honek ez dauka dokumenturik oraindik.</div>
            </div>
            <?php } ?>
        </fieldset>
