<div class="navbar">
	<div class="navbar-inner">
		<div class="brand">Galdera-erantzunak</div>
...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr <?php echo current ($klassak); ?>>
			...
			<td class="td_aukerak">
                <a class="btn" data-toggle="tooltip" title="galderak" href="<?php echo $url_base; ?>galderak?id_ariketa=<?php echo $elem['id']; ?>"><i class="icon-list"></i></a>
