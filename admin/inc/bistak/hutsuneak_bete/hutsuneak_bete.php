<div class="navbar">
	<div class="navbar-inner">
		<div class="brand">Hutsuneak bete</div>
...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr <?php echo current ($klassak); ?>>
			...
			<td class="td_aukerak">
                <a class="btn<?php if ($elem["fk_ikus_entzunezkoa"] == 0) { echo ' disabled'; } ?>" data-toggle="tooltip" title="<?php if ($elem["fk_ikus_entzunezkoa"] == 0) { echo 'Ikus-entzunezkoa gehitu hutsuneak editatu aurretik'; } else { echo 'hutsuneak'; } ?>" href="<?php echo $url_base; ?>hutsuneak?id_ariketa=<?php echo $elem['id']; ?>"<?php if ($elem["fk_ikus_entzunezkoa"] == 0) {echo 'onclick="event.preventDefault();"'; } ?>><i class="icon-list"></i></a>
