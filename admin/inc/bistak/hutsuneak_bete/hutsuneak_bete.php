<div class="navbar">
	<div class="navbar-inner">
		<div class="brand">Transkribapeneko hutsuneak bete</div>
...
<table class="table table-bordered table-hover">
	...
	<tbody>
		<?php
            $orden_max = orden_max("ariketak", "fk_ariketa_mota = 4");
		...
		<tr <?php echo current ($klassak); ?>>
			...
			<td class="td_aukerak">
                <a class="btn" data-toggle="tooltip" title="hutsuneak" href="<?php echo $url_base; ?>hutsuneak?id_ariketa=<?php echo $elem['id']; ?>"><i class="icon-list"></i></a>
