...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr <?php echo current ($klassak); ?>>
			<td class="td_klik"><?php echo elementuaren_testua("multzokatu_elementuak", "izena", $elem["id"], $hizkuntza["id"]); ?></td>
			<td class="td_aukerak">
				<a class="btn" data-toggle="tooltip" title="aldatu" href="<?php echo $url_base . "form" . $url_param . ""; ?>&id_ariketa=<?php echo $id_ariketa; ?>&id_taldea=<?php echo $id_taldea; ?>&edit_id=<?php echo $elem["id"]; ?>"><i class="icon-pencil"></i></a>
				<a class="btn" data-toggle="tooltip" title="ezabatu" href="<?php echo $url_base . "form" .  $url_param; ?>&id_ariketa=<?php echo $id_ariketa; ?>&id_taldea=<?php echo $id_taldea; ?>&ezab_id=<?php echo $elem["id"]; ?>" onclick="javascript: return (confirm ('Seguru ezabatu nahi duzula?'));"><i class="icon-trash"></i></a>
			</td>
		</tr>
