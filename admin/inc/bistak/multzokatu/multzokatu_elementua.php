...
<div class="navbar">
	<div class="navbar-inner">
		<div class="brand"><a href="<?php echo URL_BASE_ADMIN; ?>multzokatu">Multzokatu</a> > <?php echo elementuaren_testua("ariketak", "izena", $id_ariketa, $hizkuntza["id"]); ?> > <?php if($edit_id) { echo "Editatu elementua"; } else { echo "Gehitu elementua"; } ?></div>
		
		<div class="pull-right">
			<a class="btn" href="<?php echo $url_base . "?id_ariketa=" . $id_ariketa . "&id_taldea=" . $id_taldea; ?>"><i class="icon-circle-arrow-left"></i>&nbsp;Atzera</a>
		</div>
	</div>
</div>
...
<div class="formularioa">
	<form id="f1" name="f1" method="post" action="<?php echo $url_base . "form" . $url_param; ?>" class="form-horizontal" enctype="multipart/form-data" onsubmit="javascript: return verif();">
        ...
        <input type="hidden" name="id_taldea" value="<?php echo $id_taldea; ?>" />
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<input class="input-xxlarge" type="text" id="izena_<?php echo $h_id; ?>" name="izena_<?php echo $h_id; ?>" value="<?php echo testu_formatua_input($elementua->hizkuntzak[$h_id]->izena); ?>" />
			</div>
		</fieldset>
		<?php
			}
