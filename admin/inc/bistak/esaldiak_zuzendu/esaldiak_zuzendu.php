<div class="navbar">
	<div class="navbar-inner">
		<div class="brand">Esaldiak zuzendu</div>
...
<table class="table table-bordered table-hover">
	...
	<tbody>
		<?php
            $orden_max = orden_max("ariketak", "fk_ariketa_mota = 1");
		...
		<tr <?php echo current ($klassak); ?>>
			...
			<td class="td_aukerak">
                <a class="btn" data-toggle="tooltip" title="esaldiak" href="<?php echo $url_base; ?>esaldiak?id_ariketa=<?php echo $elem['id']; ?>"><i class="icon-list"></i></a>
