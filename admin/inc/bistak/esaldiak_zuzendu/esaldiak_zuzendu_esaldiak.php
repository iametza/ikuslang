<div class="navbar">
	<div class="navbar-inner">
		<div class="brand"><a href="<?php echo URL_BASE_ADMIN; ?>esaldiak-zuzendu">Esaldiak zuzendu</a> > <?php echo elementuaren_testua("ariketak", "izena", $id_ariketa, $hizkuntza["id"]); ?></div>
		
		<div class="pull-right">
			<a class="btn" href="<?php echo URL_BASE_ADMIN ?>esaldiak-zuzendu"><i class="icon-circle-arrow-left"></i>&nbsp;Atzera</a>
...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr <?php echo current ($klassak); ?>>
			<td class="td_klik"><?php echo elementuaren_testua("esaldiak_zuzendu_esaldiak", "testua", $elem["id"], $hizkuntza["id"]); ?></td>
			<td class="td_aukerak">
