<?php
    ...
    if (strtoupper($_SERVER['REQUEST_METHOD']) === 'POST') {
        ...
        if ($dbo->query($sql)) {
            ...
            $sql = "DELETE FROM ikus_entzunezkoak_tarteak " .
            ...
            if ($dbo->query($sql)) {
                ...
                foreach($tarteak as $tartea) {
                    ...
                    $sql ="INSERT INTO ikus_entzunezkoak_tarteak (indizea_hasiera, indizea_amaiera, fk_hizlaria, fk_elem, fk_hizkuntza) " .
                          "VALUES (" . $tartea['hasiera'] . ", " . $tartea['amaiera'] . ", " . $tartea['id_hizlaria'] . ", " . $id_ikus_entzunezkoa . ", " . $id_hizkuntza . ")";
